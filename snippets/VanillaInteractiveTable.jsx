export default function VanillaInteractiveTable() {
  ...
  const componentId = 'release-table-' + Math.random().toString(36).substr(2, 9);
    ...
    <div style={{ 
      ...
      <div style={{ 
        ...
        <input
          ...
          onInput={() => {
            setTimeout(() => filterTable(componentId, releaseNotes), 0);
          }}
        />
        <select
      ...
      {/* Result Count */}
      <div id={`${componentId}-count`} style={{ 
        marginBottom: '1rem', 
        color: '#6b7280',
        fontSize: '0.875rem',
        fontWeight: '500'
      ...
      <script dangerouslySetInnerHTML={{
        __html: `
          window.filterTable = function(componentId, releaseNotes) {
            const searchInput = document.getElementById(componentId + '-search');
            const categorySelect = document.getElementById(componentId + '-category');
            const yearSelect = document.getElementById(componentId + '-year');
            const tableBody = document.getElementById(componentId + '-body');
            const resultCount = document.getElementById(componentId + '-count');
