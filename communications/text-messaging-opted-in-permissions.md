...
1. From the **Search Results** page, hover over the **info icon** next to the worker's name.![Hover by name for info icon](/images/communications/info-icon-hover.png)
2. Click in the Contact area to edit her phone information.![Optin Contact Area](/images/communications/click-edit-phone.png)
3. Click the **+Add phone/email button** to add a new phone number, or just begin typing to update an existing number.
4. Select **"Cell Phone"** as the phone type.![](/images/communications/change-from-phone-to-cell-phone.png)
5. Choose the appropriate opted in reason under the **"Opted In"** drop-down menu.![](/images/communications/choose-sms-messaging-permission.png)
6. Scroll down and click **Save**.  
    ![](/images/communications/OptinContactSave.png)
...
2. [Select the workers](/viewing-search-results-and-edit/selecting-deselecting-contacts/) you want to mark "Opted In." For this example we'll select all 95 workers in our search results. ![](/images/communications/select-all-sms-opt-in.png)
3. Under **Actions**, choose “**Text Messaging Permissions.**” ![](/images/communications/OptinContactAction.png)
4. Choose an opted in reason from the **"Opted In"** drop-down menu.![](/images/communications/sms-permissions-panel-choose-reason.png)
