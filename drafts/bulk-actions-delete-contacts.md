...
2. With the contacts selected, we'll go to the **Actions** drop-down menu and choose **Delete contact(s)**.![Bulk Actions Delete Contacts](/images/getting-started/BulkActionsDeleteContacts-873x1024.png)
...
1. A panel will appear just above your search results. If you are sure that you want to continue with deletion, click Delete. ![](/images/getting-started/1contactdelete.png)
When deleting more than five contacts at once, you'll be asked to confirm your deletion by typing **DELETE** before clicking **Delete**.![](/images/getting-started/6contactdelete.png)
1. Broadstripes will automatically queue the process of deleting the selected records and their associated data. A **pop-up notification box** will appear in the upper right corner to confirm the deletion is queued. No further action is needed.![](/images/getting-started/DeletionQueueToast.png)
